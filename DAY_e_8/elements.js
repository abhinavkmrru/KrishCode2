function createDialogBox(headertxt, label1txt, label2txt, footerbtntxt, data ,footerbtn_click_fun){
    ...
    dialog_footer_btn.addEventListener("click", function(){
        footerbtn_click_fun(dialog_input.value,dialog_textarea.value);
        var dialog_container = document.getElementById("dialog_container");
        dialog_container.classList.add("display_none");
        dialog_container.innerHTML = "";
    });
