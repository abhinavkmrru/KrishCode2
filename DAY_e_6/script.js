...
function edit_task(task){
    ...
    if(task.parent){
        var dialog = createDialogBox("Edit Task","Enter Task","Description","Modify",task.taskname, task.description,function(){alert("Edited task")});
    }else{
        var dialog = createDialogBox("Edit Sub Task","Enter Sub Task","Description","Modify",task.taskname, task.description, function(){alert("Edited sub task")});
    }
